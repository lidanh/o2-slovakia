...
export async function POST(request: NextRequest) {
  try {
    ...
    if (resend) {
      ...
      // Check email is not already an active user
    ...
    // Create new invitation (token auto-generated by DB default)
    ...
    await sendInvitationEmail(email, inviterName, inviteUrl);
